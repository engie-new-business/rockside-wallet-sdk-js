...
var RocksideApi = /** @class */ (function () {
    ...
    RocksideApi.prototype.getIdentities = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.send("/ethereum/" + this.opts.network[1] + "/identities", 'GET', null)];
                    case 1:
                        resp = _a.sent();
    ...
    RocksideApi.prototype.createIdentity = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.send("/ethereum/" + this.opts.network[1] + "/identities", 'POST', {})];
                    case 1:
                        resp = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        resp = _a.sent();
                        if (!(resp.status != 201 && resp.status != 409)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.extractError(resp)];
                    case 2: throw _a.sent();
    ...
    RocksideApi.prototype.getRelayParams = function (identity, account, channel) {
        return __awaiter(this, void 0, void 0, function () {
            var route, resp, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        route = "/ethereum/" + this.opts.network[1] + "/contracts/relayableidentity/" + identity + "/relayParams";
                    ...
                    case 4:
                        json = _a.sent();
                        return [2 /*return*/, { nonce: Number(json['nonce']), relayer: json['relayer'] }];
                }
            });
        });
    };
