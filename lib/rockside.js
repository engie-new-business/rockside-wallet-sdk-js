...
var Rockside = /** @class */ (function () {
    ...
    Rockside.prototype.getProvider = function (wallet, identity) {
    ...
    Rockside.prototype.relayTransaction = function (signer, identity, tx) {
        return __awaiter(this, void 0, void 0, function () {
            var address, domain, message, _a, hash, signature;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.getRelayNonce(identity, address)];
                    case 1:
                        message = (_a.nonce = _b.sent(),
                            _a);
